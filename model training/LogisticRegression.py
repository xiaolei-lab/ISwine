...
def main():
    ...
    param_grid = [
        {'penalty': ['l1'], 'solver': ['liblinear', 'saga'],'max_iter':[100, 1000, 10000],'tol':[1e-4, 1e-5]},
        {'penalty': ['l2'], 'solver': ['newton-cg', 'lbfgs', 'liblinear', 'sag', 'saga'],'max_iter':[100, 1000, 10000],'tol':[1e-4, 1e-5]},
        {'penalty': ['none'], 'solver': ['newton-cg', 'lbfgs', 'sag', 'saga'],'max_iter':[100, 1000, 10000],'tol':[1e-4, 1e-5]},
    ]
